...
const About = () => {
  return (
    <div className="about-us-page" style={{ width: "100%" }}>
      ...
      {/* Hero Section */}
      <section className="hero-section_about" style={{ marginTop: "100px" }}>
      ...
      <section id="about-sec" className="about-section">
        <h2>About Us</h2>
        <p>
          Welcome to LUXORA Hotel. Our hotel streamlines the experience with
          efficient room reservations, guest check-ins and check-outs, and room
          management. We provide real-time availability, room allocation, and
          billing management to ensure a seamless and memorable stay for every
          guest.
        </p>
      </section>
